...
const DISPATCHER_PERMISSIONS = require('./20191026063335_insert_dispatcher_role.js').PERMISSIONS;
const LOGISTICIAN_PERMISSIONS = require('./20191029090142_insert_logistician_role.js').PERMISSIONS;
