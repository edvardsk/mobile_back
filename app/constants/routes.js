...
const ALLOWED_ROUTES = {
    GET: new Set([
        ...
        API_PREFIX + ROUTES.SEARCH.BASE + ROUTES.SEARCH.CARS.BASE + ROUTES.SEARCH.CARS.GET,
        API_PREFIX + ROUTES.SEARCH.BASE + ROUTES.SEARCH.CARS.BASE + ROUTES.SEARCH.CARS.GET_ALL,
