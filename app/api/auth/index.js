...
router.get(
    ROUTES.AUTH.REGISTRATION.BASE + ROUTES.AUTH.REGISTRATION.COUNTRIES.BASE + ROUTES.AUTH.REGISTRATION.COUNTRIES.GET_ALL,
    registration.getCountries
);

router.get(
    ROUTES.AUTH.REGISTRATION.BASE + ROUTES.AUTH.REGISTRATION.LANGUAGES.BASE + ROUTES.AUTH.REGISTRATION.LANGUAGES.GET_ALL,
