...
const formatRecordToSaveFromOriginal = (id, user, driver) => ({
    ...
    [cols.DRIVER_LICENCE_REGISTERED_AT]: driver[colsDrivers.DRIVER_LICENCE_REGISTERED_AT],
    [cols.DRIVER_LICENCE_EXPIRED_AT]: driver[colsDrivers.DRIVER_LICENCE_EXPIRED_AT],
    ...
    [cols.PASSPORT_CREATED_AT]: user[colsUsers.PASSPORT_CREATED_AT],
    [cols.PASSPORT_EXPIRED_AT]: user[colsUsers.PASSPORT_EXPIRED_AT],
